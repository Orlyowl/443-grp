...
function setConditions(conditions, conditions_img, temp, humidity) {
	...
	$("#weather2").append("<img id='weather_img' src='http://www.google.com/images/weather/" + conditions_img + "' />");
	$("#weather2").append("<div id='weather_conditions'><p id='weather_country'>" + country + "</p><p id='weather_city'>" + city + ", " + region + "</p><p id='weather_temp'>Temp: " + temp + "&deg; " + temp_type + "</p><p id='weather_hum'>Humidity: " + humidity + "%</p><p id='weather_cond'>" + conditions.substr(0, 1).toUpperCase() + conditions.substr(1) + "</p></div>");
}